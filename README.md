...
Revenue and growth carries the most weight because it is the clearest evidence that a genuine business exists. Jobs and the viability of the request follow, because a proportionate request from a business that already employs people is what a funder can actually structure a deal around. Transformation carries the least weight, not because it matters least, but because almost every applicant scores well on it, Black ownership averages 91.6% across the pool, so it separates one applicant from another far less than the other three pillars do. It stays in the score because many funders are required by their own mandates to apply it.

**One fairness rule applies to every pillar: an unanswered question is scored as neutral, at 0.5, and never as zero.** No business receives a lower score because of a question the form failed to capture. There are two deliberate exceptions, both cases where a blank genuinely means none: a reported revenue of nothing, treated as a business that has not yet started earning, and a blank staff or jobs figure, treated as no employment recorded.
...
**1.** Only 22% of applicants reach the High tier, yet it is the only one whose businesses together ask for less than they earn: **R3.24bn** requested against **R4.05bn** of revenue. These businesses employ roughly **5,690** people between them, forecast about **11,436** new jobs, and hold the strongest transformation credentials in the pool, **95.4%** average Black ownership. It needs no further preparation before an investor sees it, and it is already larger than the number of businesses the campaign matched with funders in previous rounds, 90 in the 2023 pilot and 190 in 2024, though a ready shortlist and a completed match are not the same measure.

**2.** Against expectation, the least ready tier carries the largest total request of all: **R4.40bn**, against just **R1.80bn** of revenue, from the smallest businesses in the pool at an average of 2.9 staff. Its typical request of **R800,000**, the middle request in each tier so a few very large ones do not distort the comparison, is more than double the Mid tier's **R323,500**. These are requests out of proportion to trading history, which no funder can support as written, so bringing the request down to a realistic size is the single most valuable intervention available for the lower tiers.

**3.** The pool forecasts **26,506 new jobs** in total, and the High tier alone accounts for roughly **11,436** of them, an average of **47 per business**. Those businesses already employ people at scale, which makes them the tier most credible to deliver on the forecast, and is what makes the employment and transformation case that development finance investors are mandated to fund.

**4.** Average Black ownership across the pool is **91.6%**, and every tier scores well on the transformation pillar: **15, 14 and 13 out of 20** for High, Mid and Low. B-BBEE standing and inclusive ownership are exactly the criteria many investors are required to apply, and the scoring identifies these businesses individually instead of leaving them undifferentiated among more than a thousand applicants.

**5.** The High tier held a steady **17% to 28%** share of every month's applications over the fourteen-month intake. Investor-ready businesses arrived in all fourteen months, and two thirds of them, **161 of the 245**, arrived from September 2025 onwards, which is why matching should run continuously rather than wait for the campaign to close.

**6.** **Gauteng, the Western Cape and Limpopo** account for the large majority of the pool, and the same three provinces dominate the High tier, which tells the team where an in-person or targeted development effort would reach the most businesses.
...
The High tier is ready to take to investors now: these businesses need no further work, so the task is packaging them and matching them to investors by industry, province and transformation profile. This is where the fastest deals will come from, and each one is an example the team can show to prospective investors.

The Mid tier, more than half the pool, is the largest group of businesses that could be made ready with support, and their shortcomings are specific and correctable rather than fundamental. The right response is structured support followed by a fresh score, not rejection, and converting even a portion of this tier materially increases the number of businesses reaching investors. It warrants the bulk of the team's development effort.

The Low tier's two problems, the oversized request and the incomplete application, are both resolved through direct contact with the business, after which it is scored again and can move up. That makes it a defined and prioritised body of work for later rounds rather than a write-off.

Beyond its use as an internal priority list, the scored pool is evidence in its own right: a quantified list of transformation-strong businesses the team can put in front of prospective funders to draw new capital into the campaign. The [Insights &amp; Actionable Decisions](Documents/Reports/Insights_&_Actionable_Decisions.pdf) deck is that argument, built to be presented as it is.
...
- Revenue arrives in bands rather than exact amounts: the 2023 and 2024 figures are ranges, so the model uses a representative value from the middle of each one. That is precise enough to rank and sort into tiers, but any individual comparison of request against revenue is approximate.
...
- **The weights and boundaries are fixed choices.** The 30, 25, 25 and 20 pillar weights and the 62 and 48 tier boundaries encode a defensible view of what funding readiness means, held in one place in the code and open to change as the campaign learns what actually converts.
